...
In order to generate a zipf-like distribution with Memtier, a fork of memtier \cite{zipfMemtier} with modified implementation is used as the official implementation does not support the zipf distribution.
