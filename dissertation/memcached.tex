...
The performance obtained with increased number of threads does not match our expectations of best performance at 6 threads. Let us examine the CPU utilization to gain a better insight into the problem.
